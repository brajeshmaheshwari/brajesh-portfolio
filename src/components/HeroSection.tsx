        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Button 
              variant="outline" 
              size="icon"
              className="w-12 h-12 rounded-xl hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl hover:bg-primary hover:text-primary-foreground group"
