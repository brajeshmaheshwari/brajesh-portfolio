        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-8">
            <Button 
              ...
              size="lg" 
              className="flex-1 min-w-[160px] max-w-[200px] rounded-xl px-8 py-6 text-base font-medium hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            >
              Hire Me
            </Button>
            <Button 
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="flex-1 min-w-[160px] max-w-[200px] rounded-xl px-8 py-6 text-base font-medium hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:bg-primary hover:text-primary-foreground group"
              onClick={() => window.open('https://linkedin.com/in/brajesh-patwari', '_blank')}
            >
            ...
            <Button 
              ...
              size="lg"
              className="flex-1 min-w-[160px] max-w-[200px] rounded-xl px-8 py-6 text-base font-medium hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:bg-primary hover:text-primary-foreground group"
              onClick={() => window.open('https://github.com/brajeshpatwari', '_blank')}
            >
              <svg className="w-5 h-5 mr-2 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
